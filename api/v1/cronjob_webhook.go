...
//+kubebuilder:webhook:path=/mutate-batch-example-io-v1-cronjob,mutating=true,failurePolicy=fail,sideEffects=None,groups=batch.example.io,resources=cronjobs,verbs=create;update,versions=v1,name=mcronjob.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-batch-example-io-v1-cronjob,mutating=false,failurePolicy=fail,sideEffects=None,groups=batch.example.io,resources=cronjobs,verbs=create;update;delete,versions=v1,name=vcronjob.kb.io,admissionReviewVersions=v1
...
func (r *CronJob) validateCronJob() error {
	...
	return apierrors.NewInvalid(
		schema.GroupKind{Group: "batch.example.io", Kind: "CronJob"},
		r.Name, allErrs)
}
